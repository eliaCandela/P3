...
p = [x.split()[0] for x in open('/home/lidia/PAV/P3/pitch_db/train/rl002.f0').readlines()]
p = [float(x) for x in p]
p_ref = [x for x in open('/home/lidia/PAV/P3/pitch_db/train/rl002.f0ref').readlines()]
...
wavefile, f = sf.read('/home/lidia/PAV/P3/pitch_db/train/rl002.wav')
